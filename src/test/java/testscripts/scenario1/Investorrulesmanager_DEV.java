...
public class Investorrulesmanager_DEV extends TestCase
{
	@Test
	public void runTC1() throws InvalidFormatException
	{
		testParameters.setCurrentTestDescription("Sanity Testing of Investorrulesmanager DEV Aapplication");
